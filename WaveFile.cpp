...
LONGINT CWaveFile::Read(WAVEBUFFER *pBuffer, LONGINT count)
{
	LONGINT ans;
...
LONGINT CWaveFile::Seek(LONGINT offset, LONG origin)
{
	LONGINT ans;
...
LONGINT CWaveFile::Write(WAVEBUFFER *pBuffer, LONGINT count)
{
	LONGINT ans;  
